...
class Images(commands.Cog):
            ...
            if self.reddit:
                ...
                if subreddit:
                    ...
                    if subreddit in REDDIT_ENABLED_MEME_SUBREDDITS:
                        ...
                        await ctx.send("Bitte wählen Sie einen Subreddit aus der folgenden Liste: %s NSFW-Kanäle: %s" % (list_memes, list_nsfw))
                        return

                if nsfw_flag:
                    if not ctx.channel.is_nsfw():
                        await ctx.send("Dies ist hier nicht erlaubt")
                        return
                ...
                await ctx.send("Das funktioniert nicht. Administrator kontaktieren.")

    @commands.command(brief="Zufälliges Bild eines Katzens")
    ...
    @commands.command(brief="Zufälliges Bild eines Hundes")
    ...
    @commands.command(brief="Zufälliges Bild eines Floofy")
